...
<body>
    ...
    <section class="hero-slider hero-style" id="home">
        <div class="swiper-container">
            ...
            <div class="swiper-wrapper">
                ...
                <!--slider 2 start -->
                <div class="swiper-slide">
                    <div class="slide-inner slide-bg-image" data-background="assets_front/images/hero/4.png">
                        <div class="container">
                            <div data-swiper-parallax="300" class="slide-title">
                                <h2>Sistem Informasi Industri Gorontalo</h2>
                            </div>
            ...
            <div class="row mt60">
                ...
                <div class="col-lg-12 col-sm-12 wptbb">
                    <div class="pbwide shadow bg-gradient1">
                        <div class="portfolio-item-info-tt">
                            <div class="logowide mb20"><img src="/assets_front/images/client/customer-logo-5.png" alt="logo" class="img-fluid"></div>
                        ...
                        <div class="portfolio-wide-image">
                            <div class="img-wide-blocktt tilt-outer">
                                <div class="innerwidedevice tilt-inner" data-tilt data-tilt-max="4" data-tilt-speed="1000" data-tilt-perspective="2000">
                                    <div class="desktopblock shadow1"><img src="/assets_front/images/portfolio/portfolio-wide-1.jpg" alt="img" class="img-fluid"> </div>
                                    <div class="mobileblock shadow1"><img src="/assets_front/images/portfolio/portfolio-wide-1a.jpg" alt="img" class="img-fluid"> </div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-12 col-sm-12 wptbb">
                    <div class="pbwide shadow bg-gradient2">
                        <div class="portfolio-item-info-tt">
                            <div class="logowide mb20"><img src="/assets_front/images/client/customer-logo-3.png" alt="logo" class="img-fluid"></div>
                            <div class="widebloktag"><span>Design</span> <span>Coding</span> <span>Design</span> </div>
                        ...
                        <div class="portfolio-wide-image">
                            <div class="img-wide-blocktt tilt-outer">
                                <div class="innerwidedevice tilt-inner" data-tilt data-tilt-max="4" data-tilt-speed="1000" data-tilt-perspective="2000">
                                    <div class="desktopblock shadow1"><img src="/assets_front/images/portfolio/portfolio-wide-2.jpg" alt="img" class="img-fluid"> </div>
                                    <div class="mobileblock shadow1"><img src="/assets_front/images/portfolio/portfolio-wide-2a.jpg" alt="img" class="img-fluid"> </div>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <!--Start Blogs-->
    <section class="blogs-section pb120 pt120" id="news">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="common-heading">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-sm-6 mt30">
                    <div class="single-blog-post- up-hor shdo">
                        <div class="single-blog-img-">
                            <a href="#"><img src="/assets_front/images/blog/blog-dg-1.jpg" alt="girl" class="img-fluid" /></a>
                ...
                <div class="col-lg-4 col-sm-6 mt30">
                    <div class="single-blog-post- up-hor shdo">
                        <div class="single-blog-img-">
                            <a href="#"><img src="/assets_front/images/blog/blog-dg-2.jpg" alt="girl" class="img-fluid" /></a>
                            <div class="entry-blog-post dg-bg2">
                ...
                <div class="col-lg-4 col-sm-6 mt30">
                    <div class="single-blog-post- up-hor shdo">
                        <div class="single-blog-img-">
                            <a href="#"><img src="/assets_front/images/blog/blog-dg-3.jpg" alt="girl" class="img-fluid" /></a>
                            <div class="entry-blog-post dg-bg2">
