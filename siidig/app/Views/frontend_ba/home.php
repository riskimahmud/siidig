...
<section class="service-block pad-tb light-dark bg-gradient-blue">
    <div class="container">
        ...
        <div class="row upset link-hover">
            ...
            <div class="col-lg-4 col-md-12 mt10">
                <div class="form-floating mb-3">
                    <select name="kabkota" class="form-select form-select-sm" id="floatingSelect" aria-label="Floating label select example">
