                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <select name="kabkota" id="kabkota" class="form-control <?= ($validation->hasError('kabkota')) ? 'is-invalid' : ''; ?>" placeholder="Pilih Kabupaten/Kota" autofocus>
                            ...
                            ?>
                                <option value="<?= $kk['id']; ?>" <?= set_select('kabkota', $kk['id']); ?>><?= $kk['nama_kabkota']; ?></option>
                            <?php endforeach; ?>
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nama" id="nama" class="form-control <?= ($validation->hasError('nama')) ? 'is-invalid' : ''; ?>" value="<?= set_value('nama') ?>" placeholder="Nama">
                        <div class="invalid-feedback"><?= $validation->getError('nama'); ?></div>
                    </div>
                    <div class="form-group">
                        <label for="username">Username</label>
                        <input type="text" name="username" id="username" class="form-control <?= ($validation->hasError('username')) ? 'is-invalid' : ''; ?>" value="<?= set_value('username') ?>" placeholder="Username">
