...
<div class="container-fluid">
    ...
    <div class="row">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <select name="skpd_asal" id="skpd_asal" class="form-control select2 <?= ($validation->hasError('skpd_asal')) ? 'is-invalid' : ''; ?>" data-placeholder="- Pilih SKPD Asal -" required="required">
                            <option value=""></option>
                            <?php foreach ($skpd as $un) : ?>
                                <option value="<?= $un->unorid; ?>"><?= $un->unorname; ?></option>
                            <?php endforeach; ?>
                        </select>
                        <div class="invalid-feedback"><?= $validation->getError('skpd_asal'); ?></div>
                    </div>
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <select name="eselon" id="eselon" class="form-control <?= ($validation->hasError('eselon')) ? 'is-invalid' : ''; ?>" required="required">
                            ...
                            <?php foreach ($eselon as $es) : ?>
                                <option value="<?= $es->nmeselon; ?>"><?= $es->nmeselon; ?></option>
                            <?php endforeach; ?>
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <select name="jenis_jabatan_baru" id="jenis_jabatan_baru" class="form-control <?= ($validation->hasError('jenis_jabatan_baru')) ? 'is-invalid' : ''; ?>" required="required">
                            ...
                            <?php foreach ($jenis_jabatan as $jj) : ?>
                                <option value="<?= $jj->idjabatan; ?>"><?= $jj->jabatanjns . " - " . $jj->nmjabatan; ?></option>
                            <?php endforeach; ?>
                        </select>
                        <div class="invalid-feedback"><?= $validation->getError('jenis'); ?></div>
                    </div>
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="no_surat_mutasi" id="no_surat_mutasi" class="form-control <?= ($validation->hasError('no_surat_mutasi')) ? 'is-invalid' : ''; ?>" required="required">
                            <div class="invalid-feedback"><?= $validation->getError('no_surat_mutasi'); ?></div>
                        </div>
                        <div class="form-group col-md-6">
                            <label for="tgl_surat_mutasi">Tgl Surat Mutasi</label>
                            <input type="text" name="tgl_surat_mutasi" id="tgl_surat_mutasi" class="form-control <?= ($validation->hasError('tgl_surat_mutasi')) ? 'is-invalid' : ''; ?> datepicker" data-toggle="datetimepicker" data-target="#tgl_surat_mutasi" required="required">
        ...
        <div class="col-12">
            <div class="form-group">
                <button name="submit" value="simpan" type="submit" class="btn btn-primary"><i class="fas fa-user-plus fa-fw"></i> Tambah Pegawai</button>
