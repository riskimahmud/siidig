    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="card shadow">
                ...
                <!-- form start -->
                <?= form_open("fas-halal/ubah", ["class" => "form form-horizontal", "autocomplete" => "off"]); ?>
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control <?= ($validation->hasError('nomor_sertifikat')) ? 'is-invalid' : '' ?>" name="nomor_sertifikat" id="nomor_sertifikat" value="<?= old('nomor_sertifikat', $data['nomor_sertifikat']); ?>" placeholder="Nomor Sertifikat">
                        <div class="invalid-feedback"><?= $validation->getError('nomor_sertifikat') ?></div>
                    </div>
                    <div class="form-group">
                        <label for="skala_usaha">Skala Usaha</label>
                        <input type="text" class="form-control <?= ($validation->hasError('skala_usaha')) ? 'is-invalid' : '' ?>" name="skala_usaha" id="skala_usaha" value="<?= old('skala_usaha', $data['skala_usaha']); ?>" placeholder="Skala Usaha">
