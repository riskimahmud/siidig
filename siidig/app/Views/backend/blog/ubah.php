    ...
    <div class="row">
        <div class="col-md-8">
            ...
            <div class="card shadow">
                ...
                <!-- form start -->
                <?= form_open("blog/ubah", ["class" => "form form-horizontal", "autocomplete" => "off", "enctype" => "multipart/form-data"]); ?>
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control <?= ($validation->hasError('penulis')) ? 'is-invalid' : '' ?>" name="penulis" id="penulis" value="<?= old('penulis', $data['penulis']); ?>" placeholder="Penulis">
                        <div class="invalid-feedback"><?= $validation->getError('penulis') ?></div>
                    </div>
                    <div class="form-group">
                        <label for="gambar">Gambar</label>
                        <img src="<?= base_url("uploads/berita/" . $data['gambar']); ?>" alt="Gambar" class="d-block mb-2 w-25 img-thumbnail" id="preview">
