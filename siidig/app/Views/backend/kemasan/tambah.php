    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="card shadow">
                ...
                <!-- form start -->
                <?= form_open("fas-kemasan/tambah", ["class" => "form form-horizontal", "autocomplete" => "off"]); ?>
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control <?= ($validation->hasError('produk')) ? 'is-invalid' : '' ?>" name="produk" id="produk" value="<?= old('produk'); ?>" placeholder="Produk">
                        <div class="invalid-feedback"><?= $validation->getError('produk') ?></div>
                    </div>
                    <div class="form-group">
                        <label for="no_telp">No. Telp</label>
                        <input type="text" class="form-control <?= ($validation->hasError('no_telp')) ? 'is-invalid' : '' ?>" name="no_telp" id="no_telp" value="<?= old('no_telp'); ?>" placeholder="No. Telp">
                        <div class="invalid-feedback"><?= $validation->getError('no_telp') ?></div>
                    </div>
                    <div class="form-group">
                        <label for="ukuran">Ukuran</label>
                        <input type="text" class="form-control <?= ($validation->hasError('ukuran')) ? 'is-invalid' : '' ?>" name="ukuran" id="ukuran" value="<?= old('ukuran'); ?>" placeholder="Ukuran">
                        <div class="invalid-feedback"><?= $validation->getError('ukuran') ?></div>
                    </div>
                    <div class="form-group">
                        <label for="jenis_kemasan">Jenis Kemasan</label>
                        <input type="text" class="form-control <?= ($validation->hasError('jenis_kemasan')) ? 'is-invalid' : '' ?>" name="jenis_kemasan" id="jenis_kemasan" value="<?= old('jenis_kemasan'); ?>" placeholder="Jenis Kemasan">
                    ...
                    <div class="form-group">
                        ...
                        <select name="kabkota" id="kabkota" class="form-control <?= ($validation->hasError('kabkota')) ? 'is-invalid' : '' ?>">
                            ...
                            <?php foreach ($kabkota as $kk) : ?>
                                <option value="<?= $kk['nama_kabkota'] ?>" <?= (old('kabkota') == $kk['nama_kabkota']) ? 'selected' : '' ?>><?= $kk['nama_kabkota'] ?></option>
                            <?php endforeach; ?>
                        </select>
