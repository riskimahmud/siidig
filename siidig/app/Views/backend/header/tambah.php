    ...
    <div class="row">
        <div class="col-md-8">
            ...
            <div class="card shadow">
                ...
                <!-- form start -->
                <?= form_open("header/tambah", ["class" => "form form-horizontal", "autocomplete" => "off", "enctype" => "multipart/form-data"]); ?>
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control <?= ($validation->hasError('subtitle')) ? 'is-invalid' : '' ?>" name="subtitle" id="subtitle" value="<?= old('subtitle'); ?>" placeholder="Sub Title">
                        <div class="invalid-feedback"><?= $validation->getError('subtitle') ?></div>
                    </div>
                    <div class="form-group">
                        <label for="link">Link</label>
                        <input type="url" class="form-control <?= ($validation->hasError('link')) ? 'is-invalid' : '' ?>" name="link" id="link" value="<?= old('link'); ?>" placeholder="Link">
