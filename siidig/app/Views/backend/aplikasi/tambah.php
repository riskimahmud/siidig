    ...
    <div class="row">
        <div class="col-md-8">
            ...
            <div class="card shadow">
                ...
                <!-- form start -->
                <?= form_open("aplikasi/tambah", ["class" => "form form-horizontal", "autocomplete" => "off", "enctype" => "multipart/form-data"]); ?>
                <div class="card-body">
                    <div class="form-group">
                        <label for="nama_aplikasi">Nama Aplikasi</label>
                        <input type="text" class="form-control <?= ($validation->hasError('nama_aplikasi')) ? 'is-invalid' : '' ?>" name="nama_aplikasi" id="nama_aplikasi" value="<?= old('nama_aplikasi'); ?>" placeholder="Nama Aplikasi" autofocus>
                        <div class="invalid-feedback"><?= $validation->getError('nama_aplikasi') ?></div>
                    </div>
                    <div class="form-group">
                        <label for="link">Link Aplikasi</label>
                        <input type="url" class="form-control <?= ($validation->hasError('link')) ? 'is-invalid' : '' ?>" name="link" id="link" value="<?= old('link'); ?>" placeholder="Link Aplikasi">
                ...
                <div class="card-footer">
                    ...
                    <button type="submit" class="btn btn-primary"><i class="fa fa-save fa-fw"></i> Tambah</button>
