    ...
    <div class="row">
        <div class="col-md-8">
            ...
            <div class="card shadow">
                ...
                <!-- form start -->
                <?= form_open("pelatihan/ubah", ["class" => "form form-horizontal", "autocomplete" => "off", "enctype" => "multipart/form-data"]); ?>
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control <?= ($validation->hasError('slug')) ? 'is-invalid' : '' ?>" name="slug" id="slug" value="<?= old('slug', $data['slug']); ?>" placeholder="Slug">
                        <div class="invalid-feedback"><?= $validation->getError('slug') ?></div>
                    </div>
                    <div class="form-group">
                        <label for="lokasi">Lokasi</label>
                        <input type="text" class="form-control <?= ($validation->hasError('lokasi')) ? 'is-invalid' : '' ?>" name="lokasi" id="lokasi" value="<?= old('lokasi', $data['lokasi']); ?>" placeholder="Lokasi">
                        <div class="invalid-feedback"><?= $validation->getError('lokasi') ?></div>
                    </div>
                    <div class="form-group">
                        <label for="tgl_pelaksanaan">Tgl Pelaksanaan</label>
                        <input type="date" class="form-control <?= ($validation->hasError('tgl_pelaksanaan')) ? 'is-invalid' : '' ?>" name="tgl_pelaksanaan" id="tgl_pelaksanaan" value="<?= old('tgl_pelaksanaan', $data['tgl_pelaksanaan']); ?>" placeholder="Tgl Pelaksanaan">
                    ...
                    <div class="form-group">
                        ...
                        <img src="<?= base_url("uploads/pelatihan/" . $data['gambar']); ?>" alt="Gambar" class="d-block mb-2 w-25 img-thumbnail" id="preview">
